...
# *-unknown-linux-musl is the target to use for statically-linked x86-based images
...
CMD ["./target/$(arch)-unknown-linux-musl/debug/websvc"]
...
RUN strip ./target/$(arch)-unknown-linux-musl/release/websvc -o websvc
